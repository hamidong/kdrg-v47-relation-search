...
SCRIPT_VERSION="2026-09-18_KDRG_V47_ELECTRON_STAGE50D_VALIDATOR_V11_0512"
...
def main():
    ...
    check("package version",pkg.get("version"),"0.5.12"); check("lock version",lock.get("version"),"0.5.12")
    ...
    lines=["KDRG V4.7 Stage 50D Electron Windows packaging 독립검증 - 0.5.12","="*92,f"스크립트 버전: {SCRIPT_VERSION}",""]
