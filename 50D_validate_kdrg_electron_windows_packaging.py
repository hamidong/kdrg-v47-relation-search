...
SCRIPT_VERSION = "2026-07-28_KDRG_V47_ELECTRON_STAGE50D_VALIDATOR_V4"
...
def main() -> int:
    ...
    check("실행별 fresh npm cache", "npm-cache-${{ github.run_id }}-${{ github.run_attempt }}" in workflow, True)
