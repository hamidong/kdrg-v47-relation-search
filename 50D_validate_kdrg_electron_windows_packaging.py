...
SCRIPT_VERSION="2026-09-08_KDRG_V47_ELECTRON_STAGE50D_VALIDATOR_V9_0510"
...
def main():
    ...
    lines=["KDRG V4.7 Stage 50D Electron Windows packaging 독립검증 - 0.5.10","="*92,f"스크립트 버전: {SCRIPT_VERSION}",""]
